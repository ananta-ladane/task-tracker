...
import mystyle from './Slider.module.css'
...
const Slider = () => {
    ...
    const etask = useSelector((state) => { return state.emptask })
    console.log(etask)
    console.log("this is the emp task data")

    const { id } = useParams();
    console.log(id)
    console.log("this is the head is on the slide page")
    ...
    useEffect(() => {
        ...
        // dispatcher(actions.saveLocalteam(saveteamdata));
    ...
    //     localStorage.setItem("emptaskdata", JSON.stringify(etask))
    ...
    return (
        <div className={mystyle.main}>
            ...
            <div className={mystyle.di2}>
                ...
                <p className={mystyle.di2p3}><i class="bi bi-check2-square"></i> My Tasks</p>
            ...
            <div className={mystyle.di3}>
                ...
                <p className={mystyle.di3p2}><Link to={`/tteam/${id}/singleteam/${id}`}><i class="bi bi-people"></i> Team Directory</Link></p>
                
            </div>
            <div className={mystyle.di4}>
                <p className={mystyle.di4p1}><i class="bi bi-gear"></i> Settings</p>
