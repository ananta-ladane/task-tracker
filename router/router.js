...
const { taskDatainsert, getempteam, updateDatatask, taskDelete, statuschange, statusdone, taskcancel } = require("../controller/taskopertions");
...
//taskstatus
router.post("/canceltask/:id", taskcancel)
router.post("/donestatus/:id", statusdone)
router.post("/changetaskstatus/:id", statuschange)
